...
from fairseq.data import BinarizedAudioDataset, FileAudioDatasetSepNoise
...
@register_task("audio_pretraining_sepnoise", dataclass=AudioPretrainingConfig)
class AudioPretrainingSepNoiseTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            ...
            self.datasets[split] = FileAudioDatasetSepNoise(
