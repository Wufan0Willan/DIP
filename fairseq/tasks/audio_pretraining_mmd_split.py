...
from fairseq.data import BinarizedAudioDatasetMMDSplit, FileAudioDatasetMMDSplit
...
@register_task("audio_pretraining_mmd_split", dataclass=AudioPretrainingConfig)
class AudioPretrainingMMDSplitTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetMMDSplit(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetMMDSplit(
