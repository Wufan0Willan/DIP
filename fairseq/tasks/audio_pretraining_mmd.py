...
from fairseq.data import BinarizedAudioDatasetMMD, FileAudioDatasetMMD
...
@register_task("audio_pretraining_mmd", dataclass=AudioPretrainingConfig)
class AudioPretrainingMMDTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetMMD(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetMMD(
