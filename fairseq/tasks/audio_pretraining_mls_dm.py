...
from fairseq.data import BinarizedAudioDatasetMlsDm, FileAudioDatasetMlsDm
...
@register_task("audio_pretraining_mls_dm", dataclass=AudioPretrainingConfig)
class AudioPretrainingMlsDmTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetMlsDm(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetMlsDm(
