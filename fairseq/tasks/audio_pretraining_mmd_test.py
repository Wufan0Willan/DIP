...
from fairseq.data import BinarizedAudioDatasetMMDTest, FileAudioDatasetMMDTest
...
@register_task("audio_pretraining_mmd_test", dataclass=AudioPretrainingConfig)
class AudioPretrainingMMDTestTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetMMDTest(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetMMDTest(
