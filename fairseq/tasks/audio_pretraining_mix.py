...
from fairseq.data import BinarizedAudioDataset, FileAudioDatasetMix
...
@register_task("audio_pretraining_mix", dataclass=AudioPretrainingConfig)
class AudioPretrainingMixTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            ...
            self.datasets[split] = FileAudioDatasetMix(
