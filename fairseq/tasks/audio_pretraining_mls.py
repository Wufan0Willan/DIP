...
from fairseq.data import BinarizedAudioDatasetMLS, FileAudioDatasetMLS
...
@register_task("audio_pretraining_mls", dataclass=AudioPretrainingConfig)
class AudioPretrainingMLSTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetMLS(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetMLS(
