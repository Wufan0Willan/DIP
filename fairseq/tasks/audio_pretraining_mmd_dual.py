...
from fairseq.data import BinarizedAudioDatasetMMDDual, FileAudioDatasetMMDDual
...
@register_task("audio_pretraining_mmd_dual", dataclass=AudioPretrainingConfig)
class AudioPretrainingMMDDualTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetMMDDual(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetMMDDual(
