...
from fairseq.data import BinarizedAudioDatasetPair, FileAudioDatasetPair
...
@register_task("audio_pretraining_pair", dataclass=AudioPretrainingConfig)
class AudioPretrainingPairTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetPair(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetPair(
