...
from fairseq.data import BinarizedAudioDatasetMMDC, FileAudioDatasetMMDC
...
@register_task("audio_pretraining_mmdc", dataclass=AudioPretrainingConfig)
class AudioPretrainingMMDCTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedAudioDatasetMMDC(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileAudioDatasetMMDC(
