...
@register_criterion("wav2vec_mmd_cls2", dataclass=Wav2VecCriterionConfig)
class Wav2vecCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        loss, sample_size, logging_output = self.forward_cpc(model, src_output, sample, mmd_loss_u, mmd_loss_f, domain="src")
        logging_output["correct"] = logging_output["src_correct"]
        logging_output["count"] = logging_output["src_count"]
