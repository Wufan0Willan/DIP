...
@register_criterion("wav2vec_init", dataclass=Wav2VecCriterionConfig)
class Wav2vecCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        for name, param in model.named_parameters():
            if name.startswith("feature_extractor") or name.startswith("mask_emb") or name.startswith("post_extract_proj") or name.startswith("layer_norm"):
