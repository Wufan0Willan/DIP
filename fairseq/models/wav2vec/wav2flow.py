...
@dataclass
class Wav2FlowConfig(FairseqDataclass):
...
@register_model("wav2flow", dataclass=Wav2FlowConfig)
class Wav2FlowModel(BaseFairseqModel):
    def __init__(self, cfg: Wav2FlowConfig):
        super().__init__()
        self.cfg = cfg
