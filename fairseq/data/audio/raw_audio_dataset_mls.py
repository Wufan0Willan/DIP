...
class RawAudioDatasetMLS(FairseqDataset):
    def __init__(
        self,
        sample_rate,
    ...
    def collater(self, samples):
        ...
        input = {"source": collated_sources, "label": collated_labels}
...
class FileAudioDatasetMLS(RawAudioDatasetMLS):
    def __init__(
        self,
        manifest_path,
        sample_rate,
...
class BinarizedAudioDatasetMLS(RawAudioDatasetMLS):
    def __init__(
        self,
        data_dir,
        split,
