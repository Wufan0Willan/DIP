...
class RawAudioDatasetMMDDual(FairseqDataset):
    def __init__(
        self,
        sample_rate,
...
class FileAudioDatasetMMDDual(RawAudioDatasetMMDDual):
    def __init__(
        self,
        manifest_path,
        sample_rate,
    ...
    def __getitem__(self, index):
        ...
        domain_range = self.source_range if target_domain_index == 0 else self.target_range
        tgt_index = np.random.choice(domain_range, 1, replace=True)
...
class BinarizedAudioDatasetMMDDual(RawAudioDatasetMMDDual):
    def __init__(
        self,
        data_dir,
        split,
