...
class RawAudioDatasetMMD(FairseqDataset):
    def __init__(
        self,
        sample_rate,
...
class FileAudioDatasetMMD(RawAudioDatasetMMD):
    def __init__(
        self,
        manifest_path,
        sample_rate,
        ...
        **mask_compute_kwargs,
        ...
        self.source_km_path = "_".join([manifest_base, "source.km"])
        ...
        with open(self.source_km_path, "r") as f:
            for i, label in enumerate(f):
                ...
                self.source_clusters["{0}".format(label)] = i
        ...
        self.target_km_path = "_".join([manifest_base, "target.km"])
        with open(self.target_path, "r") as f:
         ...
         with open(self.target_km_path, "r") as f:
            for i, label in enumerate(f):
                ...
                self.target_clusters["{0}".format(label)] = i
        pdb.set_trace()
    ...
    def __getitem__(self, index):
        ...
        #return {"id": index, "source": feats, "domain_index": domain_index}
...
class BinarizedAudioDatasetMMD(RawAudioDatasetMMD):
    def __init__(
        self,
        data_dir,
        split,
