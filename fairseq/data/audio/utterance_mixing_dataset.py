...
class UtteranceMixingDataset(FairseqDataset):
    ...
    def collater(self, samples):
        ...
        net_input = {"source": collated_audios, "padding_mask": padding_mask, "boundary": bnds, "mixture": collated_mix_audios}
        batch = {
            "id": torch.LongTensor([s["id"] for s in samples]),
            "net_input": net_input,
        }
        print("self.single_target:{0}".format(self.single_target))
        print("self.multitask:{0}".format(self.multitask))
